...
const styles = StyleSheet.create({
  ...
  roleBadge: { backgroundColor: '#DBEAFE', paddingHorizontal: 10, paddingVertical: 3, borderRadius: 12 },
  roleBadgeText: { fontSize: 12, color: '#1D4ED8', fontWeight: '600', textTransform: 'capitalize' },
  editBtn: {
    marginTop: 14,
    borderWidth: 1,
    borderColor: '#007AFF',
